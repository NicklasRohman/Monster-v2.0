...
public class ItemGenerator {
	...
	public Item generateItem() {
		...
		return new Item(generateName(type), type, RandomClass.getInt(rarity - 20, rarity), RandomClass.getInt(rarity - 20, rarity),  RandomClass.getInt(rarity - 20, rarity),  RandomClass.getInt(rarity - 20, rarity));
	}
